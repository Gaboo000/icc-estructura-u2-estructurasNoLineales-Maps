...
public class App {
    ...
    private static void runEmpleadoExample() {
        EmpleadoContoller empContoller = new EmpleadoContoller();
        empContoller.addEmpleado(new Empleado(1, "Gabriel", "Developer"));
        empContoller.addEmpleado(new Empleado(2, "Juan", "Developer"));
        empContoller.addEmpleado(new Empleado(3, "Miguel", "Analyst"));
        empContoller.addEmpleado(new Empleado(400, "Mario", "Developer"));

        empContoller.imprimirEmpleados();
    }
